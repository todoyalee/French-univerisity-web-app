...
class MessageParser {
    ...
    parse(message) {
      ...
      if (lowerCaseMessage.includes("salut") || lowerCaseMessage.includes("yoo")) {
        this.actionProvider.handleHello();
      }
      if (lowerCaseMessage.includes("oui") || lowerCaseMessage.includes("oeu")) {
        this.actionProvider.handleJaw();
      } 
      if (lowerCaseMessage.includes("op1") || lowerCaseMessage.includes("option1")) {
      ...
      if (lowerCaseMessage.includes("op2") || lowerCaseMessage.includes("option2") ) {
      ...
      else if (lowerCaseMessage.includes("comment ca va")) {
