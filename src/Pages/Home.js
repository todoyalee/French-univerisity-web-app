                  ...
                  <div className="col-md-12 col-sm-12">
                    <div className="home-text wow fadeIn text-center">
                      <h1 className="cd-headline clip is-full-width">
                        ...
                        >
                          <b className="is-hidden">Santé Durable</b>
                          <b className="is-hidden">Énergie Propre</b>
                          <b className="is-visible">Innovation Communautaire</b>
                        </span>
                      </h1>
              ...
              <div className="container">
                <div className="row">
                  <div className="col-md-12">
                    <div className="main-title text-center wow fadeIn">
                      ...
                      <p>
                      Bienvenue sur le site officiel Nouv Horizon de notre plateforme dédiée à l'élection présidentielle en Tunisie.
                      Notre mission est de promouvoir l'engagement citoyen en présentant une vision claire et ambitieuse pour l'avenir du secteur énergétique du pays. À travers notre entreprise spécialisée dans l'électrotechnique, nous visons à fournir des solutions innovantes et durables qui transformeront le paysage énergétique national, tout en répondant aux besoins urgents de modernisation et d'efficacité.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="row love-row wow fadeIn">
                  <div className="col-md-3 col-sm-6">
                    ...
                    <i className="fa fa-bolt love-icon" aria-hidden="true"></i>
                  ...
                  <div className="col-md-3 col-sm-6">
                    ...
                    <i className="fa fa-heartbeat love-icon" aria-hidden="true"></i>
                  ...
                  <div className="col-md-3 col-sm-6">
                    ...
                    <i className="fa fa-cogs love-icon" aria-hidden="true"></i>
                  ...
                  <div className="col-md-3 col-sm-6">
                    ...
                    <i className="fa fa-tree love-icon" aria-hidden="true"></i>
                  ...
                  <div className="col-md-8 col-sm-6 col-xs-12 about-col">
                    <div className="about-details wow fadeIn">
                      <div className="main-title left-title text-left wow fadeIn">
                        <h3>La conservation de l'énergie est notre mission.</h3>
                        <div className="underline1 no-margin"></div>
                        <div className="underline2 no-margin"></div>
                      </div>
                      <p className="wow fadeIn">
                      Nous vous invitons à explorer nos différentes sections et à en apprendre davantage sur notre vision d'une Tunisie plus moderne, verte et prospère.
                      </p>
                      <a
                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="main-title text-center wow fadeIn">
                      ...
                      <div className="underline2"></div>
                      <p>
                      Nous voulons toujours faire des choses qui ont un impact
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="row">
                    <div className="col-md-12 col-sm-12">
                      <div className="main-title text-center wow fadeIn">
                        ...
                        <div className="underline2"></div>
                        <p>
                        J'espère que nous vous avons inspiré !
